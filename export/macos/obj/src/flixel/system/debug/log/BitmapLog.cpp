...
HXLINE(  38)		 ::flixel::math::FlxPoint point2 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXDLIN( 101)				_gthis->_curMouseOffset->set(null(),null());
            			}
...
HXDLIN( 155)			 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set(X,Y);
HXDLIN( 155)			point->_inPool = false;
HXDLIN( 155)			 ::flixel::math::FlxPoint delta = point;
HXLINE( 156)			 ::flixel::math::FlxPoint _hx_tmp = this->_curMouseOffset;
HXDLIN( 156)			_hx_tmp->addPoint(delta->subtractPoint(this->_lastMousePos));
HXLINE( 157)			this->refreshCanvas(null());
HXLINE( 158)			 ::flixel::math::FlxPoint _hx_tmp1 = this->_lastMousePos;
HXDLIN( 158)			Float _hx_tmp2 = this->get_mouseX();
HXDLIN( 158)			_hx_tmp1->set(_hx_tmp2,this->get_mouseY());
            		}
            	}
...
HXDLIN( 213)			this->_curMouseOffset->set(null(),null());
            		}
...
HXDLIN( 222)			this->_curMouseOffset->set(null(),null());
            		}
...
HXLINE( 229)		this->_curMouseOffset->set(null(),null());
            	}
...
HXLINE( 309)		 ::flixel::math::FlxPoint _hx_tmp2 = this->_point;
HXDLIN( 309)		Float _hx_tmp3 = (( (Float)(this->_canvasBitmap->get_bitmapData()->width) ) / ( (Float)(2) ));
HXDLIN( 309)		_hx_tmp2->set_x((_hx_tmp3 - ((( (Float)(( ( ::openfl::display::BitmapData)(this->_entries->__get(this->_curIndex)->__Field(HX_("bitmap",ef,0f,0c,f1),::hx::paccDynamic)) )->width) ) * this->zoom) / ( (Float)(2) ))));
HXLINE( 310)		 ::flixel::math::FlxPoint _hx_tmp4 = this->_point;
HXDLIN( 310)		Float _hx_tmp5 = (( (Float)(this->_canvasBitmap->get_bitmapData()->height) ) / ( (Float)(2) ));
HXDLIN( 310)		_hx_tmp4->set_y((_hx_tmp5 - ((( (Float)(( ( ::openfl::display::BitmapData)(this->_entries->__get(this->_curIndex)->__Field(HX_("bitmap",ef,0f,0c,f1),::hx::paccDynamic)) )->height) ) * this->zoom) / ( (Float)(2) ))));
HXLINE( 312)		this->_point->addPoint(this->_curMouseOffset);
...
HXLINE( 318)		 ::openfl::display::BitmapData _hx_tmp6 = this->_canvasBitmap->get_bitmapData();
HXDLIN( 318)		 ::openfl::display::BitmapData _hx_tmp7 = ( ( ::openfl::display::BitmapData)(this->_entries->__get(this->_curIndex)->__Field(HX_("bitmap",ef,0f,0c,f1),::hx::paccDynamic)) );
HXDLIN( 318)		 ::openfl::geom::Matrix _hx_tmp8 = this->_matrix;
HXDLIN( 318)		_hx_tmp6->draw(_hx_tmp7,_hx_tmp8,null(),null(),this->_canvasBitmap->get_bitmapData()->rect,false);
...
HXLINE( 321)		 ::openfl::display::BitmapData _hx_tmp9 = this->_canvasBitmap->get_bitmapData();
HXDLIN( 321)		 ::openfl::display::Sprite _hx_tmp10 = ::flixel::util::FlxSpriteUtil_obj::flashGfxSprite;
HXDLIN( 321)		 ::openfl::geom::Matrix _hx_tmp11 = this->_matrix;
HXDLIN( 321)		_hx_tmp9->draw(_hx_tmp10,_hx_tmp11,null(),null(),this->_canvasBitmap->get_bitmapData()->rect,false);
...
HXLINE( 358)		 ::flixel::math::FlxPoint _hx_tmp = this->_lastMousePos;
HXDLIN( 358)		Float _hx_tmp1 = this->get_mouseX();
HXDLIN( 358)		_hx_tmp->set(_hx_tmp1,this->get_mouseY());
            	}
