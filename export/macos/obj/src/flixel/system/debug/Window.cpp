...
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_430_close,"flixel.system.debug.Window","close",0x8465b962,"flixel.system.debug.Window.close","flixel/system/debug/Window.hx",430,0xb8dfd4e5)
...
void Window_obj::close(){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_430_close)
HXLINE( 431)		this->destroy();
HXLINE( 433)		{
HXLINE( 433)			 ::flixel::_hx_system::debug::FlxDebugger _this = ::flixel::FlxG_obj::game->debugger;
HXDLIN( 433)			if (_this->contains(::hx::ObjectPtr<OBJ_>(this))) {
HXLINE( 433)				_this->removeChild(::hx::ObjectPtr<OBJ_>(this));
            			}
HXDLIN( 433)			{
HXLINE( 433)				::Array< ::Dynamic> array = _this->_windows;
HXDLIN( 433)				int index = array->indexOf(::hx::ObjectPtr<OBJ_>(this),null());
HXDLIN( 433)				if ((index != -1)) {
HXLINE( 433)					array[index] = array->__get((array->length - 1)).StaticCast<  ::flixel::_hx_system::debug::Window >();
HXDLIN( 433)					array->pop().StaticCast<  ::flixel::_hx_system::debug::Window >();
            				}
            			}
            		}
            	}
