...
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_166_start,"flixel.system.debug.stats.Stats","start",0x6e8a565c,"flixel.system.debug.stats.Stats.start","flixel/system/debug/stats/Stats.hx",166,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_179_stop,"flixel.system.debug.stats.Stats","stop",0x6338eb48,"flixel.system.debug.stats.Stats.stop","flixel/system/debug/stats/Stats.hx",179,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_186_destroy,"flixel.system.debug.stats.Stats","destroy",0xd5fd0174,"flixel.system.debug.stats.Stats.destroy","flixel/system/debug/stats/Stats.hx",186,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_226_update,"flixel.system.debug.stats.Stats","update",0xcb8c5ecf,"flixel.system.debug.stats.Stats.update","flixel/system/debug/stats/Stats.hx",226,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_301_updateTexts,"flixel.system.debug.stats.Stats","updateTexts",0xc9854dd7,"flixel.system.debug.stats.Stats.updateTexts","flixel/system/debug/stats/Stats.hx",301,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_314_divide,"flixel.system.debug.stats.Stats","divide",0x0399083f,"flixel.system.debug.stats.Stats.divide","flixel/system/debug/stats/Stats.hx",314,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_322_currentFps,"flixel.system.debug.stats.Stats","currentFps",0x555240f6,"flixel.system.debug.stats.Stats.currentFps","flixel/system/debug/stats/Stats.hx",322,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_330_intervalTime,"flixel.system.debug.stats.Stats","intervalTime",0x37fba938,"flixel.system.debug.stats.Stats.intervalTime","flixel/system/debug/stats/Stats.hx",330,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_338_currentMem,"flixel.system.debug.stats.Stats","currentMem",0x55578722,"flixel.system.debug.stats.Stats.currentMem","flixel/system/debug/stats/Stats.hx",338,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_347_flixelUpdate,"flixel.system.debug.stats.Stats","flixelUpdate",0xda311acb,"flixel.system.debug.stats.Stats.flixelUpdate","flixel/system/debug/stats/Stats.hx",347,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_359_flixelDraw,"flixel.system.debug.stats.Stats","flixelDraw",0xdc09ac46,"flixel.system.debug.stats.Stats.flixelDraw","flixel/system/debug/stats/Stats.hx",359,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_371_activeObjects,"flixel.system.debug.stats.Stats","activeObjects",0xffa11fa8,"flixel.system.debug.stats.Stats.activeObjects","flixel/system/debug/stats/Stats.hx",371,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_383_visibleObjects,"flixel.system.debug.stats.Stats","visibleObjects",0x48c7f948,"flixel.system.debug.stats.Stats.visibleObjects","flixel/system/debug/stats/Stats.hx",383,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_395_drawCalls,"flixel.system.debug.stats.Stats","drawCalls",0x25570e6b,"flixel.system.debug.stats.Stats.drawCalls","flixel/system/debug/stats/Stats.hx",395,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_406_onFocus,"flixel.system.debug.stats.Stats","onFocus",0x4c3dd2b3,"flixel.system.debug.stats.Stats.onFocus","flixel/system/debug/stats/Stats.hx",406,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_414_onFocusLost,"flixel.system.debug.stats.Stats","onFocusLost",0x17d97e37,"flixel.system.debug.stats.Stats.onFocusLost","flixel/system/debug/stats/Stats.hx",414,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_418_toggleSize,"flixel.system.debug.stats.Stats","toggleSize",0x72339a3b,"flixel.system.debug.stats.Stats.toggleSize","flixel/system/debug/stats/Stats.hx",418,0xc15f23b8)
HX_LOCAL_STACK_FRAME(_hx_pos_a2cdb8120663480d_441_updateSize,"flixel.system.debug.stats.Stats","updateSize",0x93323f30,"flixel.system.debug.stats.Stats.updateSize","flixel/system/debug/stats/Stats.hx",441,0xc15f23b8)
...
HXLINE( 149)			drawMethod = ((HX_("\n",0a,00,00,00) + drawMethod) + HX_(":",3a,00,00,00));
            		}
HXLINE( 152)		this->_leftTextField->set_text(((HX_("Update: \nDraw:",9b,e1,5f,a0) + drawMethod) + HX_("\nQuadTrees: \nLists:",e5,f7,d0,58)));
HXLINE( 154)		this->_toggleSizeButton =  ::flixel::_hx_system::ui::FlxSystemButton_obj::__alloc( HX_CTX , ::flixel::_hx_system::debug::stats::_Stats::GraphicMaximizeButton_obj::__alloc( HX_CTX ,0,0,null(),null()),this->toggleSize_dyn(),null());
HXLINE( 155)		this->_toggleSizeButton->set_alpha(((Float)0.8));
HXLINE( 156)		this->addChild(this->_toggleSizeButton);
HXLINE( 158)		this->updateSize();
            	}
...
void Stats_obj::start(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_166_start)
HXDLIN( 166)		if (this->_paused) {
HXLINE( 168)			this->_paused = false;
HXLINE( 169)			this->_itvTime = ::flixel::FlxG_obj::game->ticks;
HXLINE( 170)			this->_frameCount = 0;
            		}
            	}
...
void Stats_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_179_stop)
HXDLIN( 179)		this->_paused = true;
            	}
...
void Stats_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_186_destroy)
HXLINE( 187)		if (::hx::IsNotNull( this->fpsGraph )) {
HXLINE( 189)			this->fpsGraph->destroy();
HXLINE( 190)			this->removeChild(this->fpsGraph);
            		}
HXLINE( 192)		this->fpsGraph = null();
HXLINE( 194)		if (::hx::IsNotNull( this->memoryGraph )) {
HXLINE( 196)			this->removeChild(this->memoryGraph);
            		}
HXLINE( 198)		this->memoryGraph = null();
HXLINE( 200)		if (::hx::IsNotNull( this->_leftTextField )) {
HXLINE( 202)			this->removeChild(this->_leftTextField);
            		}
HXLINE( 204)		this->_leftTextField = null();
HXLINE( 206)		if (::hx::IsNotNull( this->_rightTextField )) {
HXLINE( 208)			this->removeChild(this->_rightTextField);
            		}
HXLINE( 210)		this->_rightTextField = null();
HXLINE( 212)		this->_update = null();
HXLINE( 213)		this->_draw = null();
HXLINE( 214)		this->_activeObject = null();
HXLINE( 215)		this->_visibleObject = null();
HXLINE( 216)		this->_drawCalls = null();
HXLINE( 218)		this->super::destroy();
            	}


void Stats_obj::update(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_226_update)
HXLINE( 227)		if (this->_paused) {
HXLINE( 229)			return;
            		}
HXLINE( 231)		int time = (this->_currentTime = ::flixel::FlxG_obj::game->ticks);
HXLINE( 233)		int elapsed = (time - this->_lastTime);
HXLINE( 235)		if ((elapsed > 250)) {
HXLINE( 237)			elapsed = 250;
            		}
HXLINE( 239)		this->_lastTime = time;
HXLINE( 241)		 ::flixel::_hx_system::debug::stats::Stats _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 241)		_hx_tmp->_updateTimer = (_hx_tmp->_updateTimer + elapsed);
HXLINE( 243)		this->_frameCount++;
HXLINE( 245)		if ((this->_updateTimer > 250)) {
HXLINE( 247)			this->fpsGraph->update((( (Float)(this->_frameCount) ) / (( (Float)((this->_currentTime - this->_itvTime)) ) / ( (Float)(1000) ))));
HXLINE( 248)			 ::flixel::_hx_system::debug::stats::StatsGraph _hx_tmp = this->memoryGraph;
HXDLIN( 248)			_hx_tmp->update(((( (Float)(::openfl::_hx_system::System_obj::get_totalMemory()) ) / ( (Float)(1024) )) / ( (Float)(1000) )));
HXLINE( 249)			this->updateTexts();
HXLINE( 251)			this->_frameCount = 0;
HXLINE( 252)			this->_itvTime = this->_currentTime;
HXLINE( 254)			this->updateTime = 0;
HXLINE( 255)			{
HXLINE( 255)				int _g = 0;
HXDLIN( 255)				int _g1 = this->_updateMarker;
HXDLIN( 255)				while((_g < _g1)){
HXLINE( 255)					_g = (_g + 1);
HXDLIN( 255)					int i = (_g - 1);
HXLINE( 257)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 257)					_hx_tmp->updateTime = (_hx_tmp->updateTime + this->_update->__get(i));
            				}
            			}
HXLINE( 260)			{
HXLINE( 260)				int _g2 = 0;
HXDLIN( 260)				int _g3 = this->_activeObjectMarker;
HXDLIN( 260)				while((_g2 < _g3)){
HXLINE( 260)					_g2 = (_g2 + 1);
HXDLIN( 260)					int i = (_g2 - 1);
HXLINE( 262)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 262)					_hx_tmp->activeCount = (_hx_tmp->activeCount + this->_activeObject->__get(i));
            				}
            			}
HXLINE( 264)			this->activeCount = ::Std_obj::_hx_int(this->divide(( (Float)(this->activeCount) ),( (Float)(this->_activeObjectMarker) )));
HXLINE( 266)			this->drawTime = 0;
HXLINE( 267)			{
HXLINE( 267)				int _g4 = 0;
HXDLIN( 267)				int _g5 = this->_drawMarker;
HXDLIN( 267)				while((_g4 < _g5)){
HXLINE( 267)					_g4 = (_g4 + 1);
HXDLIN( 267)					int i = (_g4 - 1);
HXLINE( 269)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 269)					_hx_tmp->drawTime = (_hx_tmp->drawTime + this->_draw->__get(i));
            				}
            			}
HXLINE( 272)			{
HXLINE( 272)				int _g6 = 0;
HXDLIN( 272)				int _g7 = this->_visibleObjectMarker;
HXDLIN( 272)				while((_g6 < _g7)){
HXLINE( 272)					_g6 = (_g6 + 1);
HXDLIN( 272)					int i = (_g6 - 1);
HXLINE( 274)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 274)					_hx_tmp->visibleCount = (_hx_tmp->visibleCount + this->_visibleObject->__get(i));
            				}
            			}
HXLINE( 276)			this->visibleCount = ::Std_obj::_hx_int(this->divide(( (Float)(this->visibleCount) ),( (Float)(this->_visibleObjectMarker) )));
HXLINE( 278)			if (::flixel::FlxG_obj::renderTile) {
HXLINE( 280)				{
HXLINE( 280)					int _g = 0;
HXDLIN( 280)					int _g1 = this->_drawCallsMarker;
HXDLIN( 280)					while((_g < _g1)){
HXLINE( 280)						_g = (_g + 1);
HXDLIN( 280)						int i = (_g - 1);
HXLINE( 282)						 ::flixel::_hx_system::debug::stats::Stats _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 282)						_hx_tmp->drawCallsCount = (_hx_tmp->drawCallsCount + this->_drawCalls->__get(i));
            					}
            				}
HXLINE( 284)				this->drawCallsCount = ::Std_obj::_hx_int(this->divide(( (Float)(this->drawCallsCount) ),( (Float)(this->_drawCallsMarker) )));
            			}
HXLINE( 287)			this->_updateMarker = 0;
HXLINE( 288)			this->_drawMarker = 0;
HXLINE( 289)			this->_activeObjectMarker = 0;
HXLINE( 290)			this->_visibleObjectMarker = 0;
HXLINE( 291)			if (::flixel::FlxG_obj::renderTile) {
HXLINE( 293)				this->_drawCallsMarker = 0;
            			}
HXLINE( 296)			 ::flixel::_hx_system::debug::stats::Stats _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 296)			_hx_tmp1->_updateTimer = (_hx_tmp1->_updateTimer - 250);
            		}
            	}


void Stats_obj::updateTexts(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_301_updateTexts)
HXLINE( 302)		Float updTime = ::flixel::math::FlxMath_obj::roundDecimal(this->divide(( (Float)(this->updateTime) ),( (Float)(this->_updateMarker) )),1);
HXLINE( 303)		Float drwTime = ::flixel::math::FlxMath_obj::roundDecimal(this->divide(( (Float)(this->drawTime) ),( (Float)(this->_drawMarker) )),1);
HXLINE( 305)		this->drawTimeGraph->update(drwTime);
HXLINE( 306)		this->updateTimeGraph->update(updTime);
HXLINE( 309)		::String _hx_tmp;
HXDLIN( 309)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 309)			_hx_tmp = (this->drawCallsCount + HX_("\n",0a,00,00,00));
            		}
            		else {
HXLINE( 309)			_hx_tmp = HX_("",00,00,00,00);
            		}
HXLINE( 308)		this->_rightTextField->set_text((((((((((((this->activeCount + HX_(" (",08,1c,00,00)) + updTime) + HX_("ms)\n",a7,a8,63,48)) + this->visibleCount) + HX_(" (",08,1c,00,00)) + drwTime) + HX_("ms)\n",a7,a8,63,48)) + _hx_tmp) + ::flixel::_hx_system::FlxQuadTree_obj::_NUM_CACHED_QUAD_TREES) + HX_("\n",0a,00,00,00)) + ::flixel::_hx_system::FlxLinkedList_obj::_NUM_CACHED_FLX_LIST));
            	}
...
Float Stats_obj::divide(Float f1,Float f2){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_314_divide)
HXDLIN( 314)		if ((f2 == 0)) {
HXDLIN( 314)			return ( (Float)(0) );
            		}
            		else {
HXDLIN( 314)			return (f1 / f2);
            		}
HXDLIN( 314)		return ((Float)0.);
            	}
...
Float Stats_obj::currentFps(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_322_currentFps)
HXDLIN( 322)		return (( (Float)(this->_frameCount) ) / (( (Float)((this->_currentTime - this->_itvTime)) ) / ( (Float)(1000) )));
            	}
...
Float Stats_obj::intervalTime(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_330_intervalTime)
HXDLIN( 330)		return (( (Float)((this->_currentTime - this->_itvTime)) ) / ( (Float)(1000) ));
            	}
...
Float Stats_obj::currentMem(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_338_currentMem)
HXDLIN( 338)		return ((( (Float)(::openfl::_hx_system::System_obj::get_totalMemory()) ) / ( (Float)(1024) )) / ( (Float)(1000) ));
            	}
...
void Stats_obj::flixelUpdate(int Time){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_347_flixelUpdate)
HXLINE( 348)		if (this->_paused) {
HXLINE( 349)			return;
            		}
HXLINE( 350)		this->_update[this->_updateMarker++] = Time;
            	}
...
void Stats_obj::flixelDraw(int Time){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_359_flixelDraw)
HXLINE( 360)		if (this->_paused) {
HXLINE( 361)			return;
            		}
HXLINE( 362)		this->_draw[this->_drawMarker++] = Time;
            	}
...
void Stats_obj::activeObjects(int Count){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_371_activeObjects)
HXLINE( 372)		if (this->_paused) {
HXLINE( 373)			return;
            		}
HXLINE( 374)		this->_activeObject[this->_activeObjectMarker++] = Count;
            	}
...
void Stats_obj::visibleObjects(int Count){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_383_visibleObjects)
HXLINE( 384)		if (this->_paused) {
HXLINE( 385)			return;
            		}
HXLINE( 386)		this->_visibleObject[this->_visibleObjectMarker++] = Count;
            	}
...
void Stats_obj::drawCalls(int Drawcalls){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_395_drawCalls)
HXLINE( 396)		if (this->_paused) {
HXLINE( 397)			return;
            		}
HXLINE( 398)		this->_drawCalls[this->_drawCallsMarker++] = Drawcalls;
            	}
...
void Stats_obj::onFocus(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_406_onFocus)
HXDLIN( 406)		this->_paused = false;
            	}
...
void Stats_obj::onFocusLost(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_414_onFocusLost)
HXDLIN( 414)		this->_paused = true;
            	}
...
void Stats_obj::toggleSize(){
            	HX_GC_STACKFRAME(&_hx_pos_a2cdb8120663480d_418_toggleSize)
HXLINE( 419)		if ((this->_width == 160)) {
HXLINE( 421)			this->resize(( (Float)(320) ),( (Float)(this->_height) ));
HXLINE( 422)			this->set_x((this->get_x() - ( (Float)(160) )));
HXLINE( 423)			this->drawTimeGraph->set_visible(true);
HXLINE( 424)			this->updateTimeGraph->set_visible(true);
HXLINE( 425)			 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp = this->_toggleSizeButton;
HXDLIN( 425)			_hx_tmp->changeIcon( ::flixel::_hx_system::debug::stats::_Stats::GraphicMinimizeButton_obj::__alloc( HX_CTX ,0,0,null(),null()));
            		}
            		else {
HXLINE( 429)			this->resize(( (Float)(160) ),( (Float)(this->_height) ));
HXLINE( 430)			this->set_x((this->get_x() + 160));
HXLINE( 431)			this->drawTimeGraph->set_visible(false);
HXLINE( 432)			this->updateTimeGraph->set_visible(false);
HXLINE( 433)			 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp = this->_toggleSizeButton;
HXDLIN( 433)			_hx_tmp->changeIcon( ::flixel::_hx_system::debug::stats::_Stats::GraphicMaximizeButton_obj::__alloc( HX_CTX ,0,0,null(),null()));
            		}
HXLINE( 436)		this->updateSize();
HXLINE( 437)		this->bound();
            	}
...
void Stats_obj::updateSize(){
            	HX_STACKFRAME(&_hx_pos_a2cdb8120663480d_441_updateSize)
HXLINE( 442)		this->super::updateSize();
HXLINE( 443)		if (::hx::IsNotNull( this->_toggleSizeButton )) {
HXLINE( 445)			 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp = this->_toggleSizeButton;
HXDLIN( 445)			int _hx_tmp1 = this->_width;
HXDLIN( 445)			_hx_tmp->set_x(((( (Float)(_hx_tmp1) ) - this->_toggleSizeButton->get_width()) - ( (Float)(3) )));
HXLINE( 446)			this->_toggleSizeButton->set_y(( (Float)(3) ));
            		}
            	}
