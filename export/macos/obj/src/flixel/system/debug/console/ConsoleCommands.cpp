...
HXLINE(  83)			::String output = HX_("System classes and commands: ",42,07,6a,e4);
HXLINE(  84)			{
HXLINE(  84)				 ::Dynamic obj = this->_console->registeredObjects->keys();
HXDLIN(  84)				while(( (bool)(obj->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  84)					::String obj1 = ( (::String)(obj->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  86)					output = (output + (obj1 + HX_(", ",74,26,00,00)));
            				}
            			}
HXLINE(  88)			{
HXLINE(  88)				 ::Dynamic func = this->_console->registeredFunctions->keys();
HXDLIN(  88)				while(( (bool)(func->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  88)					::String func1 = ( (::String)(func->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 118)		 ::flixel::FlxObject obj = ( ( ::flixel::FlxObject)(::Type_obj::createInstance(ObjClass,Params)) );
...
HXLINE( 138)		::String name = (HX_("Object_",a0,90,a0,4f) + this->_console->objectStack->length);
