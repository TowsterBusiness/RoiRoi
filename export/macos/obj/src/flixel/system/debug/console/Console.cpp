...
HX_LOCAL_STACK_FRAME(_hx_pos_c69022abc8c5c26b_310_registerClass,"flixel.system.debug.console.Console","registerClass",0x7ad06f7f,"flixel.system.debug.console.Console.registerClass","flixel/system/debug/console/Console.hx",310,0x367943c8)
HX_LOCAL_STACK_FRAME(_hx_pos_c69022abc8c5c26b_321_registerEnum,"flixel.system.debug.console.Console","registerEnum",0x75d3399a,"flixel.system.debug.console.Console.registerEnum","flixel/system/debug/console/Console.hx",321,0x367943c8)
HX_LOCAL_STACK_FRAME(_hx_pos_c69022abc8c5c26b_325_destroy,"flixel.system.debug.console.Console","destroy",0x788f2624,"flixel.system.debug.console.Console.destroy","flixel/system/debug/console/Console.hx",325,0x367943c8)
HX_LOCAL_STACK_FRAME(_hx_pos_c69022abc8c5c26b_351_updateSize,"flixel.system.debug.console.Console","updateSize",0x97e42880,"flixel.system.debug.console.Console.updateSize","flixel/system/debug/console/Console.hx",351,0x367943c8)
...
HXLINE( 280)		this->registeredFunctions->set(functionAlias,func);
HXLINE( 282)		::flixel::_hx_system::debug::console::ConsoleUtil_obj::registerFunction(functionAlias,func);
HXLINE( 285)		if (::hx::IsNotNull( helpText )) {
HXLINE( 286)			this->registeredHelp->set(functionAlias,helpText);
            		}
            	}
...
HXLINE( 297)		this->registeredObjects->set(objectAlias,anyObject);
HXLINE( 299)		::flixel::_hx_system::debug::console::ConsoleUtil_obj::registerObject(objectAlias,anyObject);
            	}
...
void Console_obj::registerClass(::hx::Class cl){
            	HX_STACKFRAME(&_hx_pos_c69022abc8c5c26b_310_registerClass)
HXDLIN( 310)		this->registerObject(::flixel::util::FlxStringUtil_obj::getClassName(cl,true),cl);
            	}
...
void Console_obj::registerEnum(::hx::Class e){
            	HX_STACKFRAME(&_hx_pos_c69022abc8c5c26b_321_registerEnum)
HXDLIN( 321)		this->registerObject(::flixel::util::FlxStringUtil_obj::getEnumName(e,true),e);
            	}
...
void Console_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_c69022abc8c5c26b_325_destroy)
HXLINE( 326)		this->super::destroy();
HXLINE( 329)		this->input->removeEventListener(HX_("focusIn",dd,45,83,41),this->onFocus_dyn(),null());
HXLINE( 330)		this->input->removeEventListener(HX_("focusOut",96,6f,5e,11),this->onFocusLost_dyn(),null());
HXLINE( 331)		this->input->removeEventListener(HX_("keyDown",a1,69,47,9c),this->onKeyDown_dyn(),null());
HXLINE( 334)		if (::hx::IsNotNull( this->input )) {
HXLINE( 336)			this->removeChild(this->input);
HXLINE( 337)			this->input = null();
            		}
HXLINE( 340)		this->registeredObjects = null();
HXLINE( 341)		this->registeredFunctions = null();
HXLINE( 342)		this->registeredHelp = null();
HXLINE( 344)		this->objectStack = null();
            	}


void Console_obj::updateSize(){
            	HX_STACKFRAME(&_hx_pos_c69022abc8c5c26b_351_updateSize)
HXLINE( 352)		this->super::updateSize();
HXLINE( 354)		this->input->set_width(( (Float)((this->_width - 4)) ));
HXLINE( 355)		this->input->set_height(( (Float)((this->_height - 15)) ));
            	}
