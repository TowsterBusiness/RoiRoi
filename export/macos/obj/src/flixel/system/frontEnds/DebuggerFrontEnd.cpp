...
HXLINE( 172)		if (!(Value)) {
HXLINE( 174)			::openfl::Lib_obj::get_current()->stage->set_focus(null());
HXLINE( 176)			::flixel::FlxG_obj::game->onFocus(null());
HXLINE( 179)			::flixel::FlxG_obj::mouse->enabled = true;
            		}
            		else {
HXLINE( 187)			::flixel::FlxG_obj::mouse->enabled = !(::flixel::FlxG_obj::game->debugger->interaction->isInUse());
            		}
HXLINE( 191)		this->visibilityChanged->dispatch();
