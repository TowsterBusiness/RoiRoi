...
HXLINE(  99)		this->super::onKeyUp(event);
HXLINE( 103)		bool _hx_tmp;
HXDLIN( 103)		if (::hx::IsNotNull( ::flixel::FlxG_obj::game->debugger )) {
HXLINE( 103)			_hx_tmp = this->inKeyArray(::flixel::FlxG_obj::debugger->toggleKeys,event);
            		}
            		else {
HXLINE( 103)			_hx_tmp = false;
            		}
HXDLIN( 103)		if (_hx_tmp) {
HXLINE( 105)			::flixel::FlxG_obj::debugger->set_visible(!(::flixel::FlxG_obj::debugger->visible));
            		}
            	}
