...
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_361_updateDebugTileBoundingBoxSolid,"flixel.tile.FlxTilemap","updateDebugTileBoundingBoxSolid",0xf2502658,"flixel.tile.FlxTilemap.updateDebugTileBoundingBoxSolid","flixel/tile/FlxTilemap.hx",361,0x448feb74)
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_366_updateDebugTileBoundingBoxNotSolid,"flixel.tile.FlxTilemap","updateDebugTileBoundingBoxNotSolid",0x299bee0b,"flixel.tile.FlxTilemap.updateDebugTileBoundingBoxNotSolid","flixel/tile/FlxTilemap.hx",366,0x448feb74)
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_371_updateDebugTileBoundingBoxPartial,"flixel.tile.FlxTilemap","updateDebugTileBoundingBoxPartial",0xa959eeee,"flixel.tile.FlxTilemap.updateDebugTileBoundingBoxPartial","flixel/tile/FlxTilemap.hx",371,0x448feb74)
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_375_updateDebugTile,"flixel.tile.FlxTilemap","updateDebugTile",0x0398ec94,"flixel.tile.FlxTilemap.updateDebugTile","flixel/tile/FlxTilemap.hx",375,0x448feb74)
...
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_422_drawDebugOnCamera,"flixel.tile.FlxTilemap","drawDebugOnCamera",0x0d929baf,"flixel.tile.FlxTilemap.drawDebugOnCamera","flixel/tile/FlxTilemap.hx",422,0x448feb74)
...
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_1105_makeDebugTile,"flixel.tile.FlxTilemap","makeDebugTile",0xa1ed2d0f,"flixel.tile.FlxTilemap.makeDebugTile","flixel/tile/FlxTilemap.hx",1105,0x448feb74)
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_1116_drawDebugTile,"flixel.tile.FlxTilemap","drawDebugTile",0x086b4839,"flixel.tile.FlxTilemap.drawDebugTile","flixel/tile/FlxTilemap.hx",1116,0x448feb74)
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_1133_onDrawDebugChanged,"flixel.tile.FlxTilemap","onDrawDebugChanged",0x3243d108,"flixel.tile.FlxTilemap.onDrawDebugChanged","flixel/tile/FlxTilemap.hx",1133,0x448feb74)
...
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_1292_set_debugBoundingBoxColorSolid,"flixel.tile.FlxTilemap","set_debugBoundingBoxColorSolid",0x6fe5cfdd,"flixel.tile.FlxTilemap.set_debugBoundingBoxColorSolid","flixel/tile/FlxTilemap.hx",1292,0x448feb74)
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_1299_set_debugBoundingBoxColorNotSolid,"flixel.tile.FlxTilemap","set_debugBoundingBoxColorNotSolid",0xa41f45a6,"flixel.tile.FlxTilemap.set_debugBoundingBoxColorNotSolid","flixel/tile/FlxTilemap.hx",1299,0x448feb74)
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_1306_set_debugBoundingBoxColorPartial,"flixel.tile.FlxTilemap","set_debugBoundingBoxColorPartial",0xf6d0c3b3,"flixel.tile.FlxTilemap.set_debugBoundingBoxColorPartial","flixel/tile/FlxTilemap.hx",1306,0x448feb74)
namespace flixel{
namespace tile{
...
HXLINE( 226)		this->set_debugBoundingBoxColorSolid(-16744448);
HXLINE( 227)		this->set_debugBoundingBoxColorPartial(-16181);
HXLINE( 228)		this->set_debugBoundingBoxColorNotSolid(0);
HXLINE( 230)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE( 231)			::flixel::FlxG_obj::debugger->drawDebugChanged->add(this->onDrawDebugChanged_dyn());
            		}
            	}
...
HXLINE( 249)			this->_debugRect = null();
HXLINE( 250)			this->_debugTileNotSolid = ::flixel::util::FlxDestroyUtil_obj::dispose(this->_debugTileNotSolid);
HXLINE( 251)			this->_debugTilePartial = ::flixel::util::FlxDestroyUtil_obj::dispose(this->_debugTilePartial);
HXLINE( 252)			this->_debugTileSolid = ::flixel::util::FlxDestroyUtil_obj::dispose(this->_debugTileSolid);
            		}
            		else {
...
HXLINE( 277)			::flixel::FlxG_obj::debugger->drawDebugChanged->remove(this->onDrawDebugChanged_dyn());
            		}
...
HXLINE( 352)		this->updateDebugTileBoundingBoxSolid();
HXLINE( 353)		this->updateDebugTileBoundingBoxNotSolid();
HXLINE( 354)		this->updateDebugTileBoundingBoxPartial();
            	}


void FlxTilemap_obj::updateDebugTileBoundingBoxSolid(){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_361_updateDebugTileBoundingBoxSolid)
HXDLIN( 361)		this->_debugTileSolid = this->updateDebugTile(this->_debugTileSolid,this->debugBoundingBoxColorSolid);
            	}
...
void FlxTilemap_obj::updateDebugTileBoundingBoxNotSolid(){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_366_updateDebugTileBoundingBoxNotSolid)
HXDLIN( 366)		this->_debugTileNotSolid = this->updateDebugTile(this->_debugTileNotSolid,this->debugBoundingBoxColorNotSolid);
            	}
...
void FlxTilemap_obj::updateDebugTileBoundingBoxPartial(){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_371_updateDebugTileBoundingBoxPartial)
HXDLIN( 371)		this->_debugTilePartial = this->updateDebugTile(this->_debugTilePartial,this->debugBoundingBoxColorPartial);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxTilemap_obj,updateDebugTileBoundingBoxPartial,(void))
 ...
 ::openfl::display::BitmapData FlxTilemap_obj::updateDebugTile( ::openfl::display::BitmapData tileBitmap,int color){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_375_updateDebugTile)
HXLINE( 376)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 377)			return null();
            		}
HXLINE( 379)		bool _hx_tmp;
HXDLIN( 379)		if ((this->_tileWidth > 0)) {
HXLINE( 379)			_hx_tmp = (this->_tileHeight <= 0);
            		}
            		else {
HXLINE( 379)			_hx_tmp = true;
            		}
HXDLIN( 379)		if (_hx_tmp) {
HXLINE( 380)			return tileBitmap;
            		}
HXLINE( 382)		bool _hx_tmp1;
HXDLIN( 382)		if (::hx::IsNotNull( tileBitmap )) {
HXLINE( 382)			if ((tileBitmap->width == this->_tileWidth)) {
HXLINE( 382)				_hx_tmp1 = (tileBitmap->height != this->_tileHeight);
            			}
            			else {
...
HXLINE( 383)			tileBitmap = ::flixel::util::FlxDestroyUtil_obj::dispose(tileBitmap);
            		}
HXLINE( 385)		if (::hx::IsNull( tileBitmap )) {
HXLINE( 386)			tileBitmap = this->makeDebugTile(color);
            		}
            		else {
HXLINE( 389)			tileBitmap->fillRect(tileBitmap->rect,0);
HXLINE( 390)			this->drawDebugTile(tileBitmap,color);
            		}
HXLINE( 393)		this->setDirty(null());
HXLINE( 394)		return tileBitmap;
            	}
...
void FlxTilemap_obj::updateMap(){
            	HX_GC_STACKFRAME(&_hx_pos_1146cbfc6764fb25_409_updateMap)
HXLINE( 411)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE( 412)			this->_debugRect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,this->_tileWidth,this->_tileHeight);
            		}
...
void FlxTilemap_obj::drawDebugOnCamera( ::flixel::FlxCamera Camera){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_422_drawDebugOnCamera)
HXLINE( 423)		if (!(::flixel::FlxG_obj::renderTile)) {
HXLINE( 424)			return;
            		}
HXLINE( 426)		 ::flixel::tile::FlxTilemapBuffer buffer = null();
HXLINE( 427)		int l = ::flixel::FlxG_obj::cameras->list->length;
HXLINE( 429)		{
HXLINE( 429)			int _g = 0;
HXDLIN( 429)			int _g1 = l;
HXDLIN( 429)			while((_g < _g1)){
HXLINE( 429)				_g = (_g + 1);
HXDLIN( 429)				int i = (_g - 1);
HXLINE( 431)				if (::hx::IsInstanceEq( ::flixel::FlxG_obj::cameras->list->__get(i).StaticCast<  ::flixel::FlxCamera >(),Camera )) {
HXLINE( 433)					buffer = this->_buffers->__get(i).StaticCast<  ::flixel::tile::FlxTilemapBuffer >();
HXLINE( 434)					goto _hx_goto_15;
            				}
            			}
            			_hx_goto_15:;
            		}
HXLINE( 438)		if (::hx::IsNull( buffer )) {
HXLINE( 439)			return;
            		}
HXLINE( 442)		this->_helperPoint->x = (this->x - (Camera->scroll->x * this->scrollFactor->x));
HXLINE( 443)		this->_helperPoint->y = (this->y - (Camera->scroll->y * this->scrollFactor->y));
HXLINE( 445)		Float rectWidth = this->_scaledTileWidth;
HXLINE( 446)		Float rectHeight = this->_scaledTileHeight;
HXLINE( 447)		 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 447)		_this->x = ( (Float)(0) );
HXDLIN( 447)		_this->y = ( (Float)(0) );
HXDLIN( 447)		_this->width = rectWidth;
HXDLIN( 447)		_this->height = rectHeight;
HXDLIN( 447)		 ::flixel::math::FlxRect rect = _this;
HXDLIN( 447)		rect->_inPool = false;
HXDLIN( 447)		 ::flixel::math::FlxRect rect1 = rect;
HXLINE( 451)		this->_point->set_x(((Camera->scroll->x * this->scrollFactor->x) - this->x));
HXLINE( 452)		this->_point->set_y(((Camera->scroll->y * this->scrollFactor->y) - this->y));
HXLINE( 453)		int screenXInTiles = ::Math_obj::floor((this->_point->x / this->_scaledTileWidth));
HXLINE( 454)		int screenYInTiles = ::Math_obj::floor((this->_point->y / this->_scaledTileHeight));
HXLINE( 455)		int screenRows = buffer->rows;
HXLINE( 456)		int screenColumns = buffer->columns;
HXLINE( 459)		 ::Dynamic Max = (this->widthInTiles - screenColumns);
HXDLIN( 459)		Float lowerBound;
HXDLIN( 459)		if ((screenXInTiles < 0)) {
HXLINE( 459)			lowerBound = ( (Float)(0) );
            		}
            		else {
HXLINE( 459)			lowerBound = ( (Float)(screenXInTiles) );
            		}
HXDLIN( 459)		Float screenXInTiles1;
HXDLIN( 459)		bool screenXInTiles2;
HXDLIN( 459)		if (::hx::IsNotNull( Max )) {
HXLINE( 459)			screenXInTiles2 = ::hx::IsGreater( lowerBound,Max );
            		}
            		else {
HXLINE( 459)			screenXInTiles2 = false;
            		}
HXDLIN( 459)		if (screenXInTiles2) {
HXLINE( 459)			screenXInTiles1 = ( (Float)(Max) );
            		}
            		else {
HXLINE( 459)			screenXInTiles1 = lowerBound;
            		}
HXDLIN( 459)		screenXInTiles = ::Std_obj::_hx_int(screenXInTiles1);
HXLINE( 460)		 ::Dynamic Max1 = (this->heightInTiles - screenRows);
HXDLIN( 460)		Float lowerBound1;
HXDLIN( 460)		if ((screenYInTiles < 0)) {
HXLINE( 460)			lowerBound1 = ( (Float)(0) );
            		}
            		else {
HXLINE( 460)			lowerBound1 = ( (Float)(screenYInTiles) );
            		}
HXDLIN( 460)		Float screenYInTiles1;
HXDLIN( 460)		bool screenYInTiles2;
HXDLIN( 460)		if (::hx::IsNotNull( Max1 )) {
HXLINE( 460)			screenYInTiles2 = ::hx::IsGreater( lowerBound1,Max1 );
            		}
            		else {
HXLINE( 460)			screenYInTiles2 = false;
            		}
HXDLIN( 460)		if (screenYInTiles2) {
HXLINE( 460)			screenYInTiles1 = ( (Float)(Max1) );
            		}
            		else {
HXLINE( 460)			screenYInTiles1 = lowerBound1;
            		}
HXDLIN( 460)		screenYInTiles = ::Std_obj::_hx_int(screenYInTiles1);
HXLINE( 462)		int rowIndex = ((screenYInTiles * this->widthInTiles) + screenXInTiles);
HXLINE( 463)		int columnIndex;
HXLINE( 464)		 ::flixel::tile::FlxTile tile;
HXLINE( 466)		{
HXLINE( 466)			int _g2 = 0;
HXDLIN( 466)			int _g3 = screenRows;
HXDLIN( 466)			while((_g2 < _g3)){
HXLINE( 466)				_g2 = (_g2 + 1);
HXDLIN( 466)				int row = (_g2 - 1);
HXLINE( 468)				columnIndex = rowIndex;
HXLINE( 470)				{
HXLINE( 470)					int _g = 0;
HXDLIN( 470)					int _g1 = screenColumns;
HXDLIN( 470)					while((_g < _g1)){
HXLINE( 470)						_g = (_g + 1);
HXDLIN( 470)						int column = (_g - 1);
HXLINE( 472)						tile = Dynamic( this->_tileObjects->__get(this->_data->__get(columnIndex))).StaticCast<  ::flixel::tile::FlxTile >();
HXLINE( 474)						bool _hx_tmp;
HXDLIN( 474)						if (::hx::IsNotNull( tile )) {
HXLINE( 474)							_hx_tmp = tile->visible;
            						}
            						else {
HXLINE( 474)							_hx_tmp = false;
            						}
HXDLIN( 474)						if (_hx_tmp) {
HXLINE( 476)							rect1->x = (this->_helperPoint->x + (( (Float)(::hx::Mod(columnIndex,this->widthInTiles)) ) * rectWidth));
HXLINE( 477)							rect1->y = (this->_helperPoint->y + (( (Float)(::Math_obj::floor((( (Float)(columnIndex) ) / ( (Float)(this->widthInTiles) )))) ) * rectHeight));
HXLINE( 478)							 ::openfl::display::Graphics _hx_tmp = Camera->debugLayer->get_graphics();
HXDLIN( 478)							this->drawDebugBoundingBox(_hx_tmp,rect1,tile->allowCollisions,(tile->allowCollisions != 4369));
            						}
HXLINE( 481)						columnIndex = (columnIndex + 1);
            					}
            				}
HXLINE( 484)				rowIndex = (rowIndex + this->widthInTiles);
            			}
            		}
HXLINE( 487)		if (!(rect1->_inPool)) {
HXLINE( 487)			rect1->_inPool = true;
HXDLIN( 487)			rect1->_weak = false;
HXDLIN( 487)			::flixel::math::FlxRect_obj::_pool->putUnsafe(rect1);
            		}
            	}
...
HXLINE( 555)				::flixel::FlxBasic_obj::visibleCount++;
            			}
            		}
HXLINE( 560)		if (::flixel::FlxG_obj::debugger->drawDebug) {
HXLINE( 561)			this->drawDebug();
            		}
            	}
...
HXLINE(1005)		 ::openfl::display::BitmapData debugTile;
HXLINE(1008)		{
...
HXDLIN(1026)								if (::flixel::FlxG_obj::debugger->drawDebug) {
HXLINE(1026)									_hx_tmp = !(this->ignoreDrawDebug);
            								}
            								else {
HXLINE(1026)									_hx_tmp = false;
            								}
HXDLIN(1026)								if (_hx_tmp) {
HXLINE(1028)									if ((tile->allowCollisions <= 0)) {
HXLINE(1030)										debugTile = this->_debugTileNotSolid;
            									}
            									else {
HXLINE(1032)										if ((tile->allowCollisions != 4369)) {
HXLINE(1034)											debugTile = this->_debugTilePartial;
            										}
            										else {
HXLINE(1038)											debugTile = this->_debugTileSolid;
            										}
            									}
HXLINE(1041)									{
HXLINE(1041)										 ::flixel::math::FlxPoint _this = this->offset;
HXDLIN(1041)										 ::openfl::geom::Point FlashPoint = this->_flashPoint;
HXDLIN(1041)										 ::openfl::geom::Point FlashPoint1 = FlashPoint;
HXDLIN(1041)										FlashPoint1->x = (FlashPoint1->x + _this->x);
HXDLIN(1041)										 ::openfl::geom::Point FlashPoint2 = FlashPoint;
HXDLIN(1041)										FlashPoint2->y = (FlashPoint2->y + _this->y);
            									}
HXLINE(1042)									Buffer->pixels->copyPixels(debugTile,this->_debugRect,this->_flashPoint,null(),null(),true);
HXLINE(1043)									{
HXLINE(1043)										 ::flixel::math::FlxPoint _this1 = this->offset;
HXDLIN(1043)										 ::openfl::geom::Point FlashPoint3 = this->_flashPoint;
HXDLIN(1043)										 ::openfl::geom::Point FlashPoint4 = FlashPoint3;
HXDLIN(1043)										FlashPoint4->x = (FlashPoint4->x - _this1->x);
HXDLIN(1043)										 ::openfl::geom::Point FlashPoint5 = FlashPoint3;
HXDLIN(1043)										FlashPoint5->y = (FlashPoint5->y - _this1->y);
            									}
            								}
            							}
            							else {
...
HX_DEFINE_DYNAMIC_FUNC2(FlxTilemap_obj,drawTilemap,(void))
 ...
 ::openfl::display::BitmapData FlxTilemap_obj::makeDebugTile(int color){
            	HX_GC_STACKFRAME(&_hx_pos_1146cbfc6764fb25_1105_makeDebugTile)
HXLINE(1106)		if (::flixel::FlxG_obj::renderTile) {
HXLINE(1107)			return null();
            		}
HXLINE(1109)		 ::openfl::display::BitmapData debugTile =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->_tileWidth,this->_tileHeight,true,0);
HXLINE(1110)		this->drawDebugTile(debugTile,color);
HXLINE(1111)		return debugTile;
            	}
...
void FlxTilemap_obj::drawDebugTile( ::openfl::display::BitmapData debugTile,int color){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_1116_drawDebugTile)
HXDLIN(1116)		if ((color != 0)) {
HXLINE(1118)			 ::openfl::display::Graphics gfx = ::flixel::util::FlxSpriteUtil_obj::flashGfx;
HXLINE(1119)			gfx->clear();
HXLINE(1120)			gfx->moveTo(( (Float)(0) ),( (Float)(0) ));
HXLINE(1121)			gfx->lineStyle(1,color,((Float)0.5),null(),null(),null(),null(),null());
HXLINE(1122)			gfx->lineTo(( (Float)((this->_tileWidth - 1)) ),( (Float)(0) ));
HXLINE(1123)			gfx->lineTo(( (Float)((this->_tileWidth - 1)) ),( (Float)((this->_tileHeight - 1)) ));
HXLINE(1124)			gfx->lineTo(( (Float)(0) ),( (Float)((this->_tileHeight - 1)) ));
HXLINE(1125)			gfx->lineTo(( (Float)(0) ),( (Float)(0) ));
HXLINE(1127)			debugTile->draw(::flixel::util::FlxSpriteUtil_obj::flashGfxSprite,null(),null(),null(),null(),null());
            		}
            	}
...
void FlxTilemap_obj::onDrawDebugChanged(){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_1133_onDrawDebugChanged)
HXDLIN(1133)		this->setDirty(null());
            	}
...
int FlxTilemap_obj::set_debugBoundingBoxColorSolid(int color){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_1292_set_debugBoundingBoxColorSolid)
HXLINE(1293)		this->super::set_debugBoundingBoxColorSolid(color);
HXLINE(1294)		this->updateDebugTileBoundingBoxSolid();
HXLINE(1295)		return color;
            	}


int FlxTilemap_obj::set_debugBoundingBoxColorNotSolid(int color){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_1299_set_debugBoundingBoxColorNotSolid)
HXLINE(1300)		this->super::set_debugBoundingBoxColorNotSolid(color);
HXLINE(1301)		this->updateDebugTileBoundingBoxNotSolid();
HXLINE(1302)		return color;
            	}


int FlxTilemap_obj::set_debugBoundingBoxColorPartial(int color){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_1306_set_debugBoundingBoxColorPartial)
HXLINE(1307)		this->super::set_debugBoundingBoxColorPartial(color);
HXLINE(1308)		this->updateDebugTileBoundingBoxPartial();
HXLINE(1309)		return color;
            	}
