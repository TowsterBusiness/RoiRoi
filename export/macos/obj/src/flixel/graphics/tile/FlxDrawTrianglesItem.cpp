...
HXLINE(  57)		if (::flixel::FlxG_obj::debugger->drawDebug) {
HXLINE(  59)			 ::openfl::display::Graphics gfx = camera->debugLayer->get_graphics();
HXLINE(  60)			gfx->lineStyle(1,-16776961,((Float)0.5),null(),null(),null(),null(),null());
HXLINE(  61)			gfx->drawTriangles(this->vertices,this->indices,null(),null());
            		}
