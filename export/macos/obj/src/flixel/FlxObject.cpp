...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1108_drawDebug,"flixel.FlxObject","drawDebug",0x2ad45ea0,"flixel.FlxObject.drawDebug","flixel/FlxObject.hx",1108,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1128_drawDebugOnCamera,"flixel.FlxObject","drawDebugOnCamera",0x0b2ef7e4,"flixel.FlxObject.drawDebugOnCamera","flixel/FlxObject.hx",1128,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1139_drawDebugBoundingBox,"flixel.FlxObject","drawDebugBoundingBox",0xa96b1247,"flixel.FlxObject.drawDebugBoundingBox","flixel/FlxObject.hx",1139,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1161_beginDrawDebug,"flixel.FlxObject","beginDrawDebug",0x8677cfb5,"flixel.FlxObject.beginDrawDebug","flixel/FlxObject.hx",1161,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1174_endDrawDebug,"flixel.FlxObject","endDrawDebug",0x2518e603,"flixel.FlxObject.endDrawDebug","flixel/FlxObject.hx",1174,0xf0fe0d80)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1242_set_width,"flixel.FlxObject","set_width",0x7d06d55a,"flixel.FlxObject.set_width","flixel/FlxObject.hx",1242,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1256_set_height,"flixel.FlxObject","set_height",0x9f435213,"flixel.FlxObject.set_height","flixel/FlxObject.hx",1256,0xf0fe0d80)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1327_set_debugBoundingBoxColorSolid,"flixel.FlxObject","set_debugBoundingBoxColorSolid",0xb8a23688,"flixel.FlxObject.set_debugBoundingBoxColorSolid","flixel/FlxObject.hx",1327,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1333_set_debugBoundingBoxColorNotSolid,"flixel.FlxObject","set_debugBoundingBoxColorNotSolid",0x55ae1bdb,"flixel.FlxObject.set_debugBoundingBoxColorNotSolid","flixel/FlxObject.hx",1333,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1339_set_debugBoundingBoxColorPartial,"flixel.FlxObject","set_debugBoundingBoxColorPartial",0x34746b1e,"flixel.FlxObject.set_debugBoundingBoxColorPartial","flixel/FlxObject.hx",1339,0xf0fe0d80)
...
HXLINE( 635)		this->ignoreDrawDebug = false;
HXLINE( 629)		this->debugBoundingBoxColorPartial = -16744448;
HXLINE( 621)		this->debugBoundingBoxColorNotSolid = -16776961;
HXLINE( 615)		this->debugBoundingBoxColorSolid = -65536;
HXLINE( 609)		this->debugBoundingBoxColor = null();
...
HXLINE( 727)		this->super::update(elapsed);
...
HXLINE( 774)		this->super::draw();
HXLINE( 775)		if (::flixel::FlxG_obj::debugger->drawDebug) {
HXLINE( 776)			this->drawDebug();
            		}
            	}
...
void FlxObject_obj::drawDebug(){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1108_drawDebug)
HXLINE(1109)		if (this->ignoreDrawDebug) {
HXLINE(1110)			return;
            		}
HXLINE(1112)		{
HXLINE(1112)			int _g = 0;
HXDLIN(1112)			::Array< ::Dynamic> _g1 = this->get_cameras();
HXDLIN(1112)			while((_g < _g1->length)){
HXLINE(1112)				 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN(1112)				_g = (_g + 1);
HXLINE(1114)				this->drawDebugOnCamera(camera);
HXLINE(1116)				bool _hx_tmp;
HXDLIN(1116)				if (::hx::IsNotNull( this->path )) {
HXLINE(1116)					_hx_tmp = !(this->path->ignoreDrawDebug);
            				}
            				else {
HXLINE(1116)					_hx_tmp = false;
            				}
HXDLIN(1116)				if (_hx_tmp) {
HXLINE(1117)					this->path->drawDebug(null());
            				}
            			}
            		}
            	}
...
void FlxObject_obj::drawDebugOnCamera( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1128_drawDebugOnCamera)
HXLINE(1129)		bool _hx_tmp;
HXDLIN(1129)		bool _hx_tmp1;
HXDLIN(1129)		if (camera->visible) {
HXLINE(1129)			_hx_tmp1 = !(camera->exists);
            		}
            		else {
HXLINE(1129)			_hx_tmp1 = true;
            		}
HXDLIN(1129)		if (!(_hx_tmp1)) {
HXLINE(1129)			_hx_tmp = !(this->isOnScreen(camera));
            		}
            		else {
...
HXLINE(1132)		 ::flixel::math::FlxRect rect = this->getBoundingBox(camera);
HXLINE(1133)		 ::openfl::display::Graphics gfx;
HXDLIN(1133)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1133)			::flixel::util::FlxSpriteUtil_obj::flashGfx->clear();
HXDLIN(1133)			gfx = ::flixel::util::FlxSpriteUtil_obj::flashGfx;
            		}
            		else {
HXLINE(1133)			gfx = camera->debugLayer->get_graphics();
            		}
HXLINE(1134)		this->drawDebugBoundingBox(gfx,rect,this->allowCollisions,this->immovable);
HXLINE(1135)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1135)			camera->buffer->draw(::flixel::util::FlxSpriteUtil_obj::flashGfxSprite,null(),null(),null(),null(),null());
            		}
            	}
...
void FlxObject_obj::drawDebugBoundingBox( ::openfl::display::Graphics gfx, ::flixel::math::FlxRect rect,int allowCollisions,bool partial){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1139_drawDebugBoundingBox)
HXLINE(1141)		 ::Dynamic color = this->debugBoundingBoxColor;
HXLINE(1142)		if (::hx::IsNull( color )) {
HXLINE(1144)			if ((allowCollisions != 0)) {
HXLINE(1146)				if (partial) {
HXLINE(1146)					color = this->debugBoundingBoxColorPartial;
            				}
            				else {
HXLINE(1146)					color = this->debugBoundingBoxColorSolid;
            				}
            			}
            			else {
HXLINE(1150)				color = this->debugBoundingBoxColorNotSolid;
            			}
            		}
HXLINE(1155)		gfx->lineStyle(1,color,((Float)0.5),null(),null(),null(),null(),null());
HXLINE(1156)		gfx->drawRect(rect->x,rect->y,rect->width,rect->height);
            	}
...
HX_DEFINE_DYNAMIC_FUNC4(FlxObject_obj,drawDebugBoundingBox,(void))
 ...
 ::openfl::display::Graphics FlxObject_obj::beginDrawDebug( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1161_beginDrawDebug)
HXDLIN(1161)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1163)			::flixel::util::FlxSpriteUtil_obj::flashGfx->clear();
HXLINE(1164)			return ::flixel::util::FlxSpriteUtil_obj::flashGfx;
            		}
            		else {
HXLINE(1168)			return camera->debugLayer->get_graphics();
            		}
...
void FlxObject_obj::endDrawDebug( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1174_endDrawDebug)
HXDLIN(1174)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1175)			camera->buffer->draw(::flixel::util::FlxSpriteUtil_obj::flashGfxSprite,null(),null(),null(),null(),null());
            		}
            	}
...
Float FlxObject_obj::set_width(Float Width){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1242_set_width)
HXLINE(1244)		if ((Width < 0)) {
HXLINE(1246)			::flixel::FlxG_obj::log->advanced(HX_("An object's width cannot be smaller than 0. Use offset for sprites to control the hitbox position!",f5,8d,0b,95),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE(1247)			return Width;
            		}
HXLINE(1251)		return (this->width = Width);
            	}
...
Float FlxObject_obj::set_height(Float Height){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1256_set_height)
HXLINE(1258)		if ((Height < 0)) {
HXLINE(1260)			::flixel::FlxG_obj::log->advanced(HX_("An object's height cannot be smaller than 0. Use offset for sprites to control the hitbox position!",b0,49,90,e4),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE(1261)			return Height;
            		}
HXLINE(1265)		return (this->height = Height);
            	}
...
int FlxObject_obj::set_debugBoundingBoxColorSolid(int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1327_set_debugBoundingBoxColorSolid)
HXDLIN(1327)		return (this->debugBoundingBoxColorSolid = color);
            	}
...
int FlxObject_obj::set_debugBoundingBoxColorNotSolid(int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1333_set_debugBoundingBoxColorNotSolid)
HXDLIN(1333)		return (this->debugBoundingBoxColorNotSolid = color);
            	}
...
int FlxObject_obj::set_debugBoundingBoxColorPartial(int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1339_set_debugBoundingBoxColorPartial)
HXDLIN(1339)		return (this->debugBoundingBoxColorPartial = color);
            	}
