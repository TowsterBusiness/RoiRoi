...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Roi Roi",b8,6d,f5,3d),::ApplicationMain_obj::create_dyn());
...
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Roi Roi",b8,6d,f5,3d));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Roi Roi",b8,6d,f5,3d));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(2,HX_("width",06,b6,62,ca),1080)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Roi Roi",b8,6d,f5,3d))
