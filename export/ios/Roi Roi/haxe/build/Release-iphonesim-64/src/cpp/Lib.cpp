...
HX_LOCAL_STACK_FRAME(_hx_pos_8919090b4e67b3fc_36_load,"cpp.Lib","load",0xd2b2dcba,"cpp.Lib.load","/usr/local/lib/haxe/std/cpp/Lib.hx",36,0x8e9e6562)
...
bool Lib_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Lib_obj::load(::String lib,::String prim,int nargs){
            	HX_STACKFRAME(&_hx_pos_8919090b4e67b3fc_36_load)
HXDLIN(  36)		return ::cpp::Lib_obj::loadLazy(lib,prim,nargs);
            	}
