...
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_342_resizeWindow,"flixel.FlxG","resizeWindow",0x41839acb,"flixel.FlxG.resizeWindow","flixel/FlxG.hx",342,0x8e176836)
...
void FlxG_obj::resizeWindow(int Width,int Height){
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_342_resizeWindow)
            	}
...
HXLINE( 598)		 ::flixel::_hx_system::frontEnds::InputFrontEnd _hx_tmp = ::flixel::FlxG_obj::inputs;
HXDLIN( 598)		::flixel::FlxG_obj::touches = _hx_tmp->add_flixel_input_touch_FlxTouchManager( ::flixel::input::touch::FlxTouchManager_obj::__alloc( HX_CTX ));
HXLINE( 602)		 ::flixel::_hx_system::frontEnds::InputFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::inputs;
HXDLIN( 602)		::flixel::FlxG_obj::gamepads = _hx_tmp1->add_flixel_input_gamepad_FlxGamepadManager( ::flixel::input::gamepad::FlxGamepadManager_obj::__alloc( HX_CTX ));
HXLINE( 610)		::flixel::FlxG_obj::accelerometer =  ::flixel::input::FlxAccelerometer_obj::__alloc( HX_CTX );
