...
HXLINE( 181)			bool tablet = ::lime::_internal::backend::native::NativeCFFI_obj::lime_system_get_ios_tablet();
HXLINE( 182)			Float scale = ::lime::app::Application_obj::current->_hx___window->_hx___scale;
HXLINE( 183)			bool _hx_tmp;
HXDLIN( 183)			if (!(tablet)) {
HXLINE( 183)				_hx_tmp = (scale > ((Float)2.46));
            			}
            			else {
HXLINE( 183)				_hx_tmp = false;
            			}
HXDLIN( 183)			if (_hx_tmp) {
HXLINE( 185)				display->dpi = ( (Float)(401) );
            			}
            			else {
HXLINE( 189)				int _hx_tmp;
HXDLIN( 189)				if (tablet) {
HXLINE( 189)					_hx_tmp = 132;
            				}
            				else {
HXLINE( 189)					_hx_tmp = 163;
            				}
HXDLIN( 189)				display->dpi = (( (Float)(_hx_tmp) ) * scale);
            			}
...
HXLINE( 751)			::lime::_hx_system::System_obj::_hx___platformName = HX_("iOS",cd,f1,4f,00);
            		}
...
HXLINE( 793)			::lime::_hx_system::System_obj::_hx___platformVersion = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_system_get_platform_version()) );
            		}
